...
public class Player_Controller : Character_Controller
{
  /*  #region Movement Inputs
    ...
    {
        //currentMovementImpairingEffect = MovementImpairingEffects.Immobilization;
    ...
    protected IEnumerator StunEnemy()
    {
        ...
        {
            Character_Controller enemyController = closestEnemy.GetComponent<Character_Controller>();
            enemyController.currentMovementImpairingEffect = MovementImpairingEffects.Stun;

            yield return new WaitForSeconds(2f);

            enemyController.currentMovementImpairingEffect = MovementImpairingEffects.None;
        } 
    }
